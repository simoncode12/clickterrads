...
<head>
    ...
    <title>Advertiser Login - Clicterra</title>
    ...
    <div class="main-container">
        ...
        <div class="login-container">
            <div class="brand-section">
                ...
                ?>
                <p class="brand-tagline animate__animated animate__fadeIn animate__delay-1s">Target Your Audience. Optimize Your ROI.</p>
            </div>
            ...
            <div class="card login-card animate__animated animate__fadeInUp">
                <div class="card-body">
                    <div class="text-center mb-4">
                        ...
                        <h3 class="portal-title">Advertiser Portal</h3>
                    </div>
                    ...
                    <div class="text-center mt-4 signup-section">
                        <p>Need an advertiser account? <a href="../contact.php" class="signup-link">Contact us</a></p>
                    </div>
                </div>
            </div>
